...
void
EnvelopeGeneratorFP::mute(bool enable)
{
  muted = enable;
}
...
// ----------------------------------------------------------------------------
void
EnvelopeGeneratorFP::writeCONTROL_REG(reg8 control)
{
...
void
EnvelopeGeneratorFP::writeATTACK_DECAY(reg8 attack_decay)
{
...
void
EnvelopeGeneratorFP::writeSUSTAIN_RELEASE(reg8 sustain_release)
{
...
void
EnvelopeGeneratorFP::update_rate_period(reg16 newperiod)
{
